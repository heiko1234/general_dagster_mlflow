...
def mlflow_training(data, configuration):
    ...
    for model_count, model_name in enumerate(configuration["Model"]):
        ...
        for scaler in configuration["Scaler"]:
            ...
            try:
                ...
                model_parameter = configuration["Model"][model_count][model_name]
                model_parameter_dict = model_parameter

            except BaseException:
                model_parameter_dict = None

            model_pipe = make_model_pipeline(
                sk_model=sklearn_models_dict[model_name],
...
# configuration = read_configuration(configuration_file_path="/home/heiko/Repos/dagster/general_dagster_mlflow/config_for_azure_blobstorage/job_mlflow_training_config.yaml")

# configuration
# configuration["EnsembledModel"]
