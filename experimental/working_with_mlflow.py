...
model= get_mlflow_model(model_name="manufacturing_model", azure=True)

model.predict()



# get meta data of models

feature_dtypes_dict = create_all_model_json_dict(local=False,
    list_of_models=["manufacturing_model"],
    features="feature_dtypes.json")
...
# local pickle file
# model= get_mlflow_model(model_name="manufacturing_model", azure=False, local_model_dir = "./model_dump")
...
model= get_mlflow_model(model_name="manufacturing_model", azure=True, local_model_dir = None)

model.predict(data)  #37.8
model.predict(data2)  #37.8
model.predict(data3)  #37.8
